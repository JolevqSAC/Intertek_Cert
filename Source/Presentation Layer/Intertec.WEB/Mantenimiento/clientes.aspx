<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="clientes.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.clientes" %>
    ...
    <div class="contentgeneral">
        ...
        <div class="conteradio1">
            <div class="bar1">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblRazonSocial" runat="server" Text="Razón Social: "></asp:Label></p>
                </div>
                <div class="line175">
                    <asp:TextBox ID="txtRazonSocial" MaxLength="150" CssClass="bordeimput" Width="750px"
            ...
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblRUC" runat="server" Text="RUC: "></asp:Label></p>
                </div>
                <div class="line174">
                    <asp:TextBox ID="txtRUC" MaxLength="11" CssClass="bordeimput" Width="100px" Height="20px"
                        runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvRUC" runat="server" ErrorMessage="*" ControlToValidate="txtRUC"
                        CssClass="letraError"></asp:RequiredFieldValidator>
                </div>
                <div class="line177_2">
                    <p>
                        <asp:Label ID="lblTelefono1" runat="server" Text="Telf. Oficina: "></asp:Label></p>
                </div>
                <div class="line176">
                    <asp:TextBox ID="txtTelefono1" MaxLength="20" CssClass="bordeimput" Width="105px"
                        Height="20px" runat="server"></asp:TextBox></div>
                <div class="line177_2">
                    <p>
                        <asp:Label ID="lblTelefonoPlanta" runat="server" Text="Telf. Planta: "></asp:Label></p>
                </div>
                <div class="line176">
                ...
                <div class="line178">
                    <p>
                        <asp:Label ID="lblFax" runat="server" Text="Fax: "></asp:Label></p>
                </div>
                <div class="line176">
            ...
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblEmail" runat="server" Text="E-mail: "></asp:Label></p>
                </div>
                <div class="line175">
            ...
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblContacto" runat="server" Text="Contacto: "></asp:Label></p>
                </div>
                <div class="line175">
                    <asp:TextBox ID="txtContacto" MaxLength="150" CssClass="bordeimput" Width="455px"
                        Height="20px" runat="server"></asp:TextBox></div>
            </div>
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblDireccion" runat="server" Text="Dirección: "></asp:Label></p>
                </div>
                <div class="line175">
            ...
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblPais" runat="server" Text="País: "></asp:Label></p>
                </div>
                <div class="line179">
                ...
                <div class="line180">
                    <p>
                        <asp:Label ID="lblDepartamento" runat="server" Text="Departamentos: "></asp:Label></p>
                </div>
                <div class="line179">
            ...
            <div class="bar2">
                <div class="line173">
                    <p>
                        <asp:Label ID="lblProvincia" runat="server" Text="Provincias: "></asp:Label></p>
                </div>
                <div class="line179">
                ...
                <div class="line180">
                    <p>
                        <asp:Label ID="lblDistrito" runat="server" Text="Distrito: "></asp:Label></p>
                </div>
                <div class="line179">
