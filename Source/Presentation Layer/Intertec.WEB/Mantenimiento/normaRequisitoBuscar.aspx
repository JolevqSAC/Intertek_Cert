<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="normaRequisitoBuscar.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.normaRequisitoBuscar" meta:resourcekey="PageResource1" %>
...
<script type="text/javascript">
    ...
    function VerificarSeleccionados() {
        ...
        $('#<%= dgvnormasrequisito.ClientID %> tr').each(function (indexF) {
        ...
        <div class="titulo2">
            <div class="ti1"><p>
                <asp:Label ID="lbltitulo" runat="server" 
                    Text="Buscar Norma de Requisito" meta:resourcekey="lbltituloResource1" ></asp:Label></p>
            </div>
    ...
    <div class="separa">
        <div class="conteradio1">
            <div class="bar5">
                ...
                <asp:GridView ID="dgvnormasrequisito" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                    Width="700px" CssClass="gridview" 
                        onpageindexchanging="dgvnormasrequisito_PageIndexChanging" 
                        onrowcommand="dgvnormasrequisito_RowCommand" 
                        meta:resourcekey="dgvnormasrequisitoResource1" PageSize="20">
                    <Columns>
                                               
                        <asp:BoundField DataField="NRE_Codigo" HeaderText="Código" 
                            ItemStyle-Width="100px" meta:resourcekey="BoundFieldResource1" 
                             >
<ItemStyle Width="100px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="NRE_Nombre" HeaderText="Nombre" 
                            ItemStyle-Width="150px" meta:resourcekey="BoundFieldResource2"
                             >
<ItemStyle Width="150px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="NRE_Descripcion" HeaderText="Descripcion"  
                            ItemStyle-Width="400px" meta:resourcekey="BoundFieldResource3"
                           >
<ItemStyle Width="400px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="NRE_Acreditador" HeaderText="Acreditador" 
                            ItemStyle-Width="150px" meta:resourcekey="BoundFieldResource4"
                             >
<ItemStyle Width="150px"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="NRE_Anio" HeaderText="Año"  ItemStyle-Width="50px" meta:resourcekey="BoundFieldResource5"
                           >                           
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px" 
                            meta:resourcekey="TemplateFieldResource1">
                                   ...
                                   <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hidIdRequisito" runat="server" Value='<%# Eval("IDNormaRequisito") %>' />
                                   </ItemTemplate>  
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" meta:resourcekey="TemplateFieldResource2" 
                            ...
                            <ItemTemplate>
                               <asp:LinkButton ID="lkbEditar" ToolTip="Modificar" runat="server" CausesValidation="False"
                                    CommandName="Editar" CommandArgument='<%# Eval("IDNormaRequisito") %>' 
                    ...
                    <div class="boxletra2">
                        <p>
                            <strong>
                                ...
                                Text="Debe seleccionar al menos una norma requisito para eliminar." 
