<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="estado.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.estado" %>
        ...
        <div class="bar1">
            ...
            <div class="line175">
                    <asp:TextBox ID="txtDescripcion" runat="server" CssClass="bordeimput" Width="700px" 
                        Height="20px" MaxLength="20" ></asp:TextBox>
            ...
            <div class="line175">
                <asp:TextBox ID="txtTipo" runat="server" 
                 CssClass="bordeimput" Width="100px" Height="20px" MaxLength="3" 
                  ...
                  ErrorMessage="*" ControlToValidate="txtTipo" 
