<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tipoEnvaseBuscar.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.tipoEnvaseBuscar" %>
    ...
    <div class="titulo1">
        <div class="titulo2">
            <div class="ti1"><p><asp:Label ID="lbltitulo" runat="server" 
                    Text="Buscar Tipo Envase" ></asp:Label></p>
            </div>
    ...
    <div class="separa">
        <div class="conteradio1">
            <div class="bar5">
                ...
                <asp:GridView ID="dgvtipoenvase" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                    Width="500px" CssClass="gridview" 
                        onpageindexchanging="dgvtipoenvase_PageIndexChanging" 
                        onrowcommand="dgvtipoenvase_RowCommand">
                    <Columns>
                                               
                        <asp:BoundField DataField="IDTiposEnvase" HeaderText="Código"
                            />
                        <asp:BoundField DataField="TIE_Descripcion" HeaderText="Descripción" 
                            />
                        <asp:TemplateField HeaderText="Opciones" ItemStyle-HorizontalAlign="Center" 
                            ...
                            <ItemTemplate>
                               <asp:LinkButton ID="lkbEditar" ToolTip="Editar" runat="server" CausesValidation="False"
                                    CommandName="Editar" CommandArgument='<%# Eval("IDTiposEnvase") %>' 
                               ...
                               <img  src="../img/quitar.png" alt="" title="Eliminar"  style="cursor:pointer; border:0" 
                                     onclick="javascript:MostrarMensajeEliminar('msjConfirmacion','<%# Eval("IDTiposEnvase") %>');"/>
