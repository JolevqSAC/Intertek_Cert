<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="normaMuestreo.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.normaMuestreo" meta:resourcekey="PageResource1" %>
        ...
        <div class="titulo2">
           <div class="ti1"><p>
               <asp:Label ID="lblTitulo" runat="server" 
                   Text="Registrar Norma Muestreo" meta:resourcekey="lblTituloResource1" ></asp:Label></p>
           </div>
        ...
        <div class="bar1">
            ...
            <div class="line172">
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="bordeimput"  Width="700px" 
                        Height="20px" MaxLength="100" onkeypress="javascript:return validarChr(event)" meta:resourcekey="txtNombreResource1"></asp:TextBox>                   
            </div>
        ...
        <div class="bar5option">
                ...
                <div class="line93">
                            <asp:TextBox ID="txtDescripcion" runat="server" 
                             ...
                             onChange="javascript:Count(this,200);" meta:resourcekey="txtDescripcionResource1"></asp:TextBox>
                </div>
        ...
        <div class="bar2">
             ...
             <div class="line172">
                <asp:TextBox ID="txtAcreditador" runat="server" 
                 CssClass="bordeimput"  Width="700px" Height="20px" MaxLength="150" onkeypress="javascript:return validarChr(event)"  
                ...
                <div class="boxdentro">
                    ...
                    <div class="boxbtn">
                        <div class="centerclose">
                            ...
                            OnClientClick="CerrarDialogoC('msjRegistroOK','normaMuestreoBuscar.aspx');" CausesValidation="False" 
