<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="neoproveedores.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.neoproveedores"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentgeneral">
            ...
            <div id="tabs-1">
                <div class="bar1">
                    ...
                    <div class="line172">
                        ...
                        <asp:HiddenField ID="hdflIDProveedor" runat="server" />
                    </div>
                    <div class="line8">
                        <p>
                            <asp:Label ID="Label11" runat="server" Text="*" class="letraError"></asp:Label></p>
                    </div>
                </div>
                <div class="bar2">
                    <div class="line173">
                ...
                <div class="bar2">
                    ...
                    <div class="line175">
                        ...
                        <asp:Label ID="lblerrorEmail" runat="server"  Text="Formato de Email no válido"
                            class="letraError" Visible="False" 
                            meta:resourcekey="lblerrorEmailResource1" ></asp:Label>
                ...
                <div class="bar2">
                    ...
                    <div class="line8">
                        <p>
                            <asp:Label ID="Label12" runat="server" Text="*" class="letraError"></asp:Label></p>
                    </div>
                </div>
                <div class="bar2">
                    <div class="line173">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="bar2">
                            <div class="line173">
                                <p>
                                    <asp:Label ID="lblContacto" runat="server" Text="Nombres: " meta:resourcekey="lblContactoResource1"></asp:Label>
                            ...
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label13" runat="server" Text="*" class="letraError"></asp:Label></p>
                            </div>
                            <div class="line180">
                                <p>
                                    <asp:Label ID="Label1" runat="server" Text="Apellidos: " meta:resourcekey="Label1Resource1"></asp:Label></p>
                            </div>
                            <div class="line179">
                            ...
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label14" runat="server" Text="*" class="letraError"></asp:Label></p>
                            </div>
                        </div>
                        <div class="bar2">
                            <div class="line173">
                            ...
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label16" runat="server" Text="" class="letraError">&nbsp;</asp:Label></p>
                            </div>
                            <div class="line180">
                                <p>
                            ...
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label15" runat="server" Text="*" class="letraError"></asp:Label></p>
                            </div>
                        </div>
                        <div class="bar2">
                            <div class="line173">
                            ...
                            <div class="line179">
                                ...
                                <input type="button" runat="server" id="btnEliminar0" value="Quitar" class="btnquitar" />
                                    ...
                                    <asp:Button ID="btnQuitarContacto"  UseSubmitBehavior="false" runat="server" CssClass="ocultarBoton" meta:resourcekey="btnQuitarContactoResource1"
                                        CausesValidation="False" OnClick="btnQuitarContacto_Click" />

                                </div>
                                <div class="btns2" id="divbntActualizarContacto" runat="server" visible="False">
                                    <asp:Button ID="bntActualizarContacto" runat="server" CssClass="<%$ Resources:generales,imgGrabar %>"  meta:resourcekey="bntActualizarContactoResource1"
                                        ValidationGroup="validarCliente2" UseSubmitBehavior="False" OnClick="bntActualizarContacto_Click" />
                                </div>
                        ...
                        <div class="bar11">
                            <div class="line225">
                                <asp:GridView ID="grvwContacto" runat="server" CssClass="gridview" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="COC_Nombres" HeaderText="Nombre" meta:resourcekey="BoundFieldResource1" />
                                        <asp:BoundField DataField="COC_Apellidos" HeaderText="Apellido" meta:resourcekey="BoundFieldResource2" />
                                        <asp:BoundField DataField="COC_Cargo" HeaderText="Cargo" meta:resourcekey="BoundFieldResource3" />
                                        <asp:BoundField DataField="COC_Telefono1" HeaderText="Telefono" meta:resourcekey="BoundFieldResource4" />
                                        ...
                                        <asp:TemplateField HeaderText="Selec." meta:resourcekey="TemplateFieldResource1">
                                            <ItemTemplate>
                                                <center>
                                                    ...
                                                    <asp:HiddenField ID="hidIdContacto" runat="server" Value='<%# Eval("IDContactoProveedor") %>' />
                                                </center>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField meta:resourcekey="TemplateFieldResource2">
                                            <ItemTemplate>
                                                <center>
                                                    <%--
                                                            <asp:Button ID="btnModificarContacto" runat="server" Text="Modificar"  CssClass="btnmodificar2"
                                                        meta:resourcekey="btnModificarContactoResource1" CausesValidation="False" 
                                                        OnClick="btnModificarContacto_Click" />--%>
                                                    <asp:LinkButton ID="lkbEditar" ToolTip="Modificar" runat="server" CausesValidation="False"
                                                        CommandName="Editar" CommandArgument='<%# Eval("IDContactoProveedor") %>' meta:resourcekey="lkbEditarResource1">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <div class="bar2">
                            ...
                            <div class="line179">
                                <asp:DropDownList ID="drdwlsTipo" runat="server" CssClass="bordeimput" Height="20px"
                                    MaxLength="150" Width="200px" meta:resourcekey="drdwlsTipoResource1">
                                    <asp:ListItem meta:resourcekey="ListItemResource1">Seleccionar</asp:ListItem>
                                    <asp:ListItem Value="Almacen" meta:resourcekey="ListItemResource2">Almacen</asp:ListItem>
                                    <asp:ListItem Value="Tienda" meta:resourcekey="ListItemResource3">Tienda</asp:ListItem>
                            ...
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label17" runat="server" Text="*" class="letraError"></asp:Label></p>
                            </div>
                            <div class="line173">
                                <p>
                            ...
                            <div class="line179">
                                <div class="btns2" id="divbtnAgregarDireccion" runat="server">
                                    <asp:Button ID="btnAgregarDireccion" runat="server" CssClass="<%$ Resources:generales,imgAgregar %>"
                                        meta:resourcekey="btnAgregarDireccionResource1" ValidationGroup="validarCliente3"
                                        UseSubmitBehavior="False" OnClick="btnAgregarDireccion_Click" />
                                </div>
                                <div class="btns3" id="divbtnQuitarDireccion" runat="server">
                                   <input type="button" runat="server" id="btnEliminar3" value="Quitar" class="btnquitar" />
                                    <asp:Button ID="btnQuitarDireccion" runat="server" UseSubmitBehavior="false"  CssClass="ocultarBoton"  meta:resourcekey="btnQuitarContactoResource1"
                                        OnClick="btnQuitarDireccion_Click" />
                                </div>
                                <div class="btns2" id="divbntActualizarDireccion" runat="server" visible="False">
                                    <asp:Button ID="bntActualizarDireccion" runat="server" CssClass="<%$ Resources:generales,imgGrabar %>" meta:resourcekey="bntActualizarDireccionResource1"
                                        CausesValidation="False" OnClick="bntActualizarDireccion_Click" />
                                </div>
                        ...
                        <div class="bar2">
                            ...
                            <div class="line172">
                                <asp:TextBox ID="txtDireccioSecundar" MaxLength="150" CssClass="bordeimput" Width="700px"
                                    Height="20px" runat="server" meta:resourcekey="txtDireccioSecundarResource1"></asp:TextBox>
                            </div>
                            <div class="line8">
                                <p>
                                    <asp:Label ID="Label18" runat="server" Text="*" class="letraError"></asp:Label></p>
                            </div>
                        </div>
                        <div class="bar11">
                            <div class="line225">
                                <asp:GridView ID="grvwDireccion" runat="server" CssClass="gridview" AutoGenerateColumns="False"
                                    ...
                                    PageSize="5" meta:resourcekey="grvwDireccionResource1" OnRowCommand="grvwDireccion_RowCommand">
                                    <Columns>
                                        <asp:BoundField DataField="DIP_Tipo" HeaderText="Tipo" meta:resourcekey="BoundFieldResource6" />
                                        <asp:BoundField DataField="DIP_Descripcion" HeaderText="Dirección" meta:resourcekey="BoundFieldResource7" />
                                        <asp:TemplateField HeaderText="Selec." meta:resourcekey="TemplateFieldResource3">
                                            <ItemTemplate>
                                                <center>
                                                    ...
                                                    <asp:HiddenField ID="hidIdDireccion" runat="server" Value='<%# Eval("IDDireccionProveedor") %>' />
                                                </center>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField meta:resourcekey="TemplateFieldResource4">
                                            <ItemTemplate>
                                                <center>
                                                    <asp:LinkButton ID="lkbEditar" ToolTip="Modificar" runat="server" CausesValidation="False"
                                                        CommandName="Editar" CommandArgument='<%# Eval("IDDireccionProveedor") %>' meta:resourcekey="lkbEditarResource1">
                                                    <img src="/img/btnmdificar.png" alt="Modificar" style="border:0" /></asp:LinkButton>
                                                </center>
                                            </ItemTemplate>
                                            <ItemStyle BorderStyle="None" Width="90px" />
        ...
        <div class="bar4">
            <div class="bar4tres">
                <div class="btns2">
                    <asp:Button ID="btnGrabar" runat="server" UseSubmitBehavior="false"  CssClass="ocultarBoton" ClientIDMode="Static"
                        OnClick="btnGrabar_Click" meta:resourcekey="btnGrabarResource1" />
                    <img id="imgGrabar" runat="server" src="../img/btngrabar2.png" onclick="javascript:return ValidaCampos()"
                        alt="" class="imgCursor" />
                </div>
                <div class="btns3">
            ...
            <div class="boxtext">
                <div class="boxdentro">
                    <div class="boxletra">
                        <p>
                            <strong>
                                <asp:Label ID="lblConfirmacion" runat="server" Text="El registro se grabó satisfactoriamente"
                                    meta:resourcekey="lblConfirmacionResource1"></asp:Label></strong></p>
                    </div>
                    <div class="boxbtn">
                        <div class="centerclose">
                            <asp:Button ID="btnCerrarConfirmacion" OnClientClick="javascript:CerrarDialogoC('msjSatisfactorio','proveedoresBuscar.aspx');"
            ...
            <div class="boxtext">
                <div class="boxdentro">
                    <div class="boxletra2">
                        <p>
                            <strong>
                                <asp:Label ID="Label9" runat="server" Text="Debe ingresar los campos obligatorios marcados con asterisco(*)"
                    ...
                    <div class="boxbtn">
                        <div class="centerclose">
                            <asp:Button runat="server" ID="btnCerrarObligatorios" CssClass="<%$ Resources:generales,imgCerrar %>"
                                OnClientClick="CerrarDialogo('msjCamposObligatorios');" CausesValidation="False"
                                meta:resourcekey="btnCerrarConfirmacionResource1" /></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="boxbtn">
                        <div class="centerclose">
                            <asp:Button ID="btnEliminar_3" OnClientClick="javascript:EliminarSi3();" runat="server"
                                CssClass="<%$ Resources:generales,imgSi %>" meta:resourcekey="btnAceptarResource1" />
                            <asp:Button ID="btnEliminar33" OnClientClick="javascript:CerrarDialogoC('msjError');"
                                runat="server" CssClass="<%$ Resources:generales,imgNo %>" meta:resourcekey="btnNoResource1" />
                        </div>
                    </div>
                </div>
            </div>
