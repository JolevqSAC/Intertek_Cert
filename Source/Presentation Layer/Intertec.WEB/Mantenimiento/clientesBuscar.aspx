<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="clientesBuscar.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.clientesBuscar" meta:resourcekey="PageResource1" %>
    ...
    <div class="contentgeneral">
        <div class="titulo1">
            <div class="titulo2">
                <div class="ti1">
                    <p>
                        <asp:Label ID="lblTitulo" runat="server" Text="Buscar Cliente" 
            ...
            <div class="bar2">
                ...
                <div class="line175">
                    <asp:TextBox ID="txtRazonSocial" runat="server" CssClass="bordeimput" MaxLength="150"
                        Width="700px" meta:resourcekey="txtRazonSocialResource1"></asp:TextBox></div>
            </div>
            <div class="bar2">
                <div class="line173">
                    <p>
                    ...
                    <center> <asp:Label ID="lblmensaje" runat="server" CssClass="letraError"></asp:Label> </center>
                        ...
                        onrowcommand="gvBuscar_RowCommand" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CLI_RazonSocial" HeaderText="Razón Social" 
                                    meta:resourcekey="BoundFieldResource2" />
                                <asp:BoundField DataField="CLI_Ruc" HeaderText="Ruc" 
                                    meta:resourcekey="BoundFieldResource3" />
                                <asp:BoundField DataField="CLI_IndicadorArea" HeaderText="Indicador Área" 
                                ...
                                <asp:TemplateField HeaderText="Selec." 
                                    ...
                                    <ItemTemplate>
                                        <center>
                                            ...
                                            <asp:HiddenField ID="hidIdCliente" runat="server" Value='<%# Eval("IDCliente") %>' />
                                        </center>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <center>
                                           <%-- <asp:HyperLink runat="server" ID="hypActualizar" ImageUrl="~/img/btnmodificar.png"
                                                ...
                                                NavigateUrl='<%# "~/Mantenimiento/neoclientes.aspx?idCliente="+Eval("IDCliente") %>' 
                                                meta:resourcekey="hypActualizarResource1"></asp:HyperLink>--%>
                                                 <asp:LinkButton ID="hypActualizar" ToolTip="Modificar" runat="server" CausesValidation="False"
                                                CommandName="Editar" CommandArgument='<%# Eval("IDCliente") %>' meta:resourcekey="hypActualizarResource1">
