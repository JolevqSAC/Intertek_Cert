<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="comentario.aspx.cs" Inherits="Intertek.WEB.Mantenimiento.comentario" meta:resourcekey="PageResource1" %>
        ...
        <div class="titulo2">
           <div class="ti1"><p>
               <asp:Label ID="lblTitulo" runat="server" 
                   Text="Registrar Nota" meta:resourcekey="lblTituloResource1"></asp:Label></p>
           </div>
        ...
        <div class="bar1">
            ...
            <div class="line172">
                    <asp:TextBox ID="txtNombre" runat="server" CssClass="bordeimput" Width="700px" 
                        Height="20px" MaxLength="100" meta:resourcekey="txtNombreResource1"></asp:TextBox>
             </div>
            <div class="line178"><p><asp:Label ID="Label1" runat="server" Text="*" class="letraError"></asp:Label></p></div>
        </div>
        <div class="bar5option">
             <div class="line182">
                    <p><asp:Label ID="lblDescripcion" runat="server" Text="Descripción:" meta:resourcekey="lblDescripcionResource1" 
                            ></asp:Label></p>
            </div>
            <div class="line93">
                    <asp:TextBox ID="txtDescripcion" runat="server" CssClass="bordeimput"  
                     ...
                     MaxLength="200" TextMode="MultiLine" onKeyUp="javascript:Count(this,200);" 
                        onChange="javascript:Count(this,800);" 
                ...
                <div class="boxdentro">
                    ...
                    <div class="boxbtn">
                        <div class="centerclose">
                            ...
                            OnClientClick="CerrarDialogoC('msjRegistroOK','comentarioBuscar.aspx');" CausesValidation="False" 
                    ...
                    <div class="boxbtn">
                        <div class="centerclose">
                            <asp:Button runat="server" ID="btncerrar3" CssClass="<%$ Resources:generales,imgCerrar %>"
                                OnClientClick="CerrarDialogo('msjErrorExiste');" meta:resourcekey="btncerrar3Resource1" 
                                /></div>
                    </div>
                </div>
            </div>
